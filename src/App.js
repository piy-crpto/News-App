...
const App = ()=> {
  const pageSize = 5;
   const  apiKey = '7726136795ee4a0e9a12ad9896242351';
  const [progress, setProgress] = useState(0)
    ...
    return (
      ...
      />
        <Switch>
          <Route exact path="/"><News setProgress={setProgress} apiKey={apiKey}  pageSize={pageSize} country="in" category="general"/></Route> 
